    ...
    <div className="bg-primary sticky top-0 z-50 text-gray-300 py-4 px-4 md:px-12">
      <div className="container mx-auto flex flex-row md:flex-cpl justify-between items-start md:items-center">
        <div className="flex flex-col md:flex-row  justify-between">
          <span className="mr-0 md:mr-4 text-sm md:text-lg flex items-center">
            <i className="ri-mail-line text-background text-lg mr-1 "></i>
            contact-us@shipwidelogistics.online
          </span>
          <span className="text-sm md:text-lg flex items-center">
            <i className="ri-whatsapp-line text-background text-lg mr-1 "></i>
            +1 (682) 261-8986
          </span>
        </div>
        <div className="flex flex-col md:flex-row  justify-between">
          <span className="text-sm md:text-lg flex items-center">
            <i className="ri-time-line text-background text-lg mr-1 "></i>
            24/7 Support
          </span>
        </div>
      </div>
